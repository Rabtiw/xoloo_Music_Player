...
public class songplay6 extends AppCompatActivity {
    MediaPlayer mp;
    SeekBar position;
    TextView textView16;
    TextView textView17;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_songplay6);

        mp=MediaPlayer.create(this,R.raw.qaafirana);
