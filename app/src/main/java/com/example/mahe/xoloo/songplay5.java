...
public class songplay5 extends AppCompatActivity {
    MediaPlayer mp;
    SeekBar position;
    TextView textView14;
    TextView textView15;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_songplay5);

        mp=MediaPlayer.create(this,R.raw.bekhayali);
