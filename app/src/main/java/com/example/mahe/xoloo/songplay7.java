...
public class songplay7 extends AppCompatActivity {
    MediaPlayer mp;
    SeekBar position;
    TextView textView18;
    TextView textView19;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_songplay7);

        mp=MediaPlayer.create(this,R.raw.soorajdoobahainyaaronroy);
